...
public class ReservasView extends JFrame {
	...
	private void guardarReserva() {
		if(txtFechaE.getDate() != null && txtFechaS.getDate() != null && !txtValor.equals("")
			...
			reserva reserva3 = new reserva (dataE,dataS, txtValor.getText(), txtFormaPago.getSelectedItem().toString());
			reservaControl.guardar(reserva3);
			
			RegistroHuesped registro = new RegistroHuesped(reserva3.getId());
	...
	public void calcularValor(JDateChooser dataE, JDateChooser dataS) {
		if(dataE.getDate()!= null && dataS.getDate() != null ) {
			...
			int dias = -1; //PARA CONTAR DESDE DIA SIGUIENTE
